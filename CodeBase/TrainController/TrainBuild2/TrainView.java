...
public class TrainView extends javax.swing.JFrame{
	...
	public void update(){
		trackElevationField.setText(Integer.toString(tm.elevation) + "ft");
        trackGradeFld.setText(Integer.toString(tm.grade) + "ft");
        psngrEnteringFld.setText(Integer.toString(tm.psngrEnter));
        authorityFld.setText(Integer.toString(tm.authority) + " blocks");
        ...
        curSpdFld.setText(Integer.toString(tm.curSpd));
        psngrCountField.setText(Integer.toString(tm.curPassengers));
        pwrReqField.setText(Integer.toString(tm.powReq));
	}
	...
	private int UpdateVelocity(){
		...
		//Use currentWeight to get weight of train w/ passengers
    ...
    private void initComponents() {
        ...
        paramDataTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                ...
                {"Train length", tm.length},
                {"Train width", tm.width},
                {"Train height", tm.height},
                {"Train mass (empty)", tm.trainWeight},
                {"Maximum passengers", tm.maxPassenger},
                {"Maximum acceleration", tm.maxAcceleration},
                {"Maximum deacceleration", tm.maxDeceleration},
                {"Maximum speed", tm.maxSpd},
                {"Crew count", tm.crewCount}
            },
            new String [] {
        ...
        authorityFld.setText(Integer.toString(tm.authority) + "mi");
