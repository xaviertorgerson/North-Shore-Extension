...
public class TrainView extends javax.swing.JFrame{
	...
	public void update(){
        ...
        autoField.setText(tm.boolToString(tm.auto));
        adField.setText(tm.boolToString(tm.ad));
        brakeField.setText(tm.boolToString(tm.srvBrk || tm.psngrBrk));
        ebrakeField.setText(tm.boolToString(tm.eBrk));
	...
	public int stoppingDistance(float deltaT){
		float curWeight = currentWeight();
