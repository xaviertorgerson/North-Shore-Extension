...
public class CTCGUI extends javax.swing.JFrame {
    ...
    private void SendSuggestionActionPerformed(java.awt.event.ActionEvent evt) {                                               
		...
		trackCont.updateSpeedAuth("Green", 152, (float)25, (float)(10));
		trackCont.updateSpeedAuth("Green", 62, (float)25, (float)(8));
		trackCont.updateSpeedAuth("Green", 63, (float)25, (float)(6));
		trackCont.updateSpeedAuth("Green", 64, (float)25, (float)(4));
		trackCont.updateSpeedAuth("Green", 65, (float)25, (float)(2));
